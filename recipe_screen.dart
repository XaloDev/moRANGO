      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            _Divider(),
            _Ingredients("Ingredientes - Massa", " • 1 xícara de chá de leite\n • 1 xícara de chá de óleo de soja\n • 2 unidades de ovo\n • 2 xícaras de chá de farinha de trigo\n • 1 xícara de chá de achocolatado em pó\n • 1 xícara de chá de açúcar\n • 1 colheres de sopa de fermento químico em pó"),
            _Divider(),
            _Ingredients("Ingredientes - Cobertura", " • 2 colheres de sopa de manteiga\n • 3 colheres de sopa de achocolatado em pó\n • 3 colheres de sopa de açúcar\n • 5 colheres de sopa de leite"),
            _Divider(),
            _PrepMode("Modo de Preparo - Massa", "Coloque os líquidos no liquidificador e bata até misturar bem."),
            _PrepStep("Coloque os outros ingredientes, sendo o fermento o último.", 2),
            _PrepStep("Leve para assar em forno médio, numa forma untada e enfarinhada.", 3),
            _Divider(),
            Container(
              padding: EdgeInsets.fromLTRB(8, 0, 8, 10),
              child: Text(
